<template>
    <div class="web" v-cloak>
        ...
        <mheader :getTitleUrl="titleUrl" :titleType="'home'">
            <!-- 208-184 -->
            <img
                src="//yoo.qpic.cn/yoo_img/0/74f0881a5d2db3af7f8e67402055575b/0"
                alt
                class="icon_angle"
            />
        </mheader>
        <div class="hcontent">
            <div class="window">
                <img
                    src="//yoo.qpic.cn/yoo_img/0/836bdf02c0dfa8f74be0cbf6c1b255ac/0"
                    alt
                />
                ...
                <div class="l_cloud slideleft">
                    <img
                        src="//yoo.qpic.cn/yoo_img/0/447648d7e7104b22bb3f156ebf619e5e/0"
                        alt
                    />
                </div>
                <div class="r_cloud slideright">
                    <img
                        src="//yoo.qpic.cn/yoo_img/0/eb3f88ad958a247537fffb03ed8d73b3/0"
                        alt
                    />
                </div>
            ...
            <div class="upload_wrapper" v-show="!isupload">
                <div class="upload_btn">
                    ...
                    <label>
                        <img
                            src="//yoo.qpic.cn/yoo_img/0/6c7662dcc98b5d3d0610cd8cf2fe3ade/0"
                            alt
                        />
        ...
        <div class="hlogo">
            <img
                style="opacity:0;display:none;position:absolute;z-index:-1;"
                src="//yoo.qpic.cn/yoo_img/0/8341e52172bb1fec401ef54b69cc5c75/0"
                alt="欢遇logo"
            />
            <logo></logo>
        </div>
...
export default {
    ...
    methods: {
        ...
        async first_step(fileName) {
            return axios
                .post(
                    "/fcgi/gwlogout/GetTencentCloudInfo",
                    {
                        BizID: "QZ",
                        File: fileName
                    },
        ...
        async second_step(url, filecontent) {
            return axios
                .put(url, filecontent, axiosConfig)
                .then(res => {
                    if (res.status !== 200) {
...
=======
			share_url = window.share_url = `https://qzi.html5.qq.com/fission_activitie/#?type=${type}&uuid=${uuid}${!result?'':`&result=${result}`}`;
>>>>>>> a6a7435bbcf8c468482b407185a10d9fc63083d1
            let config = {
                url: share_url,
                title: window.title,
                desc: window.desc,
